...
### Визуальный дизайн:
Вкладки: «Читаю сейчас», «Моя библиотека». В «Читаю сейчас»: крупная карточка текущей книги с прогресс-баром (% прочтения), кнопкой «Продолжить». Сетка книжных обложек для других вкладок.
...
Текст книги (главы): загружается постранично по мере необходимости (с предзагрузкой). Текущая позиция в тексте (номер страницы, скролл) — постоянно обновляется локально.
...
Вкладки: «Рецензии». Карточка рецензии: аватар, имя, текст

Данные из API (динамический социальный контент): Массив рецензий на данную книгу.

Данные локально: Черновик собственной рецензии или комментария (сохраняется локально до отправки).
